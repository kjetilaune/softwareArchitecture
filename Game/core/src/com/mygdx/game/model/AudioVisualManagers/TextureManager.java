...
public class TextureManager {
    ...
    public static Texture tastyMissileSweets = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Sweets_1.png"));
    public static Texture instastuffedSweets = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Sweets_2.png"));
    public static Texture yummyGrenadeFastfood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Fastfood_0.png"));
    public static Texture tastyMissileFastfood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Fastfood_1.png"));
    public static Texture instastuffedFastfood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Fastfood_2.png"));
    public static Texture yummyGrenadeVegan = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Vegan_0.png"));
    public static Texture tastyMissileVegan = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Vegan_1.png"));
    public static Texture instastuffedVegan = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Vegan_2.png"));
    public static Texture yummyGrenadeSeafood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Seafood_0.png"));
    public static Texture tastyMissileSeafood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Seafood_1.png"));
    public static Texture instastuffedSeafood = new Texture(Gdx.files.internal("objects/bullets/small/Bullet_Seafood_2.png"));
    ...
    public static Texture storeTastyMissileSweets = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Sweets_1.png"));
    public static Texture storeInstastuffedSweets = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Sweets_2.png"));
    ...
    public static Texture storeTastyMissileFastfood = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Fastfood_1.png"));
    public static Texture storeInstastuffedFastfood = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Fastfood_2.png"));
    ...
    public static Texture storeTastyMissileVegan = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Vegan_1.png"));
    public static Texture storeInstastuffedVegan = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Vegan_2.png"));
    ...
    public static Texture storeTastyMissileSeafood = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Seafood_1.png"));
    public static Texture storeInstastuffedSeafood = new Texture(Gdx.files.internal("objects/bullets/large/View_Bullet_Seafood_2.png"));
